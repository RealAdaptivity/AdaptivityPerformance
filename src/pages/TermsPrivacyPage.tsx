          ...
          <div className="space-y-4 text-xs sm:text-sm text-slate-300 leading-relaxed">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div className="bg-[#0b0c10] p-4 rounded-2xl border border-white/5 space-y-2">
                ...
                <p className="text-slate-300 leading-relaxed">
                  Mobile dispatch appointments canceled with less than 2 hours notice, or customer no-shows after the technician arrives, may be billed the ${DIAGNOSTIC_FEE_DOLLARS} diagnostic as the late cancellation or no-show fee. No additional late-dispatch fee is charged unless the customer separately approves it before service.
                </p>
              </div>
